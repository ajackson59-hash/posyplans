...
<p id="state">Reading the study record…</p><button id="run" disabled>Run the approved eight-case study</button><main id="cases"></main>
<script type="module">
...
run.disabled=!manifest.paidEnabled||previouslyClaimed;
