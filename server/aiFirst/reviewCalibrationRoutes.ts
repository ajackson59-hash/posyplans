...
import { CALIBRATION_CASES, CONSISTENCY_CASES, CALIBRATION_OWNER_EVENT, runReviewCalibration, type CalibrationCaseId } from "./reviewCalibration";
...
export function registerReviewCalibrationRoutes(app: Express,
  ...
  const caseSet = dataset === "consistency-v1" ? CONSISTENCY_CASES : CALIBRATION_CASES;
  const path = dataset === "consistency-v1" ? "consistency-calibration" : "calibration";
